...
const PurchaseModal = ({ product, isOpen, onClose }: PurchaseModalProps) => {
  ...
  const [prices, setPrices] = useState<TokenPrices>({
    eth: 3000, // Default price, will be replaced by API data
    solana: 150,
    sui: 2.5
  });
  ...
  const getBalanceDisplay = () => {
    switch (selectedChain) {
      case 'eth':
        return ethBalance ? `${parseFloat(ethBalance.formatted).toFixed(4)} ETH` : 'Loading...';
      case 'solana':
      ...
      case 'sui':
        ...
        return suiWallet.connected ? `${suiWallet.account?.address ? 'Balance available' : '0.0000'} SUI` : 'Loading...';
      default:
        return 'Unknown';
    }
  };
            ...
            <div className="flex gap-2 mb-[20px]">
              <button
                ...
                className={`w-[29%] mr-[10px] p-[10px] rounded-lg border transition-all duration-200 ${
                  selectedChain === 'eth'
                    ? 'bg-blue-100 border-blue-500 shadow-lg shadow-blue-500/10'
              ...
              <button
                ...
                className={`w-[29%] mr-[10px] p-3 rounded-lg border transition-all duration-200 ${
                  selectedChain === 'solana'
                    ? 'bg-purple-100 border-purple-500 shadow-lg shadow-purple-500/10'
              ...
              <button
                ...
                className={`w-[29%]   p-3 rounded-lg border transition-all duration-200 ${
                  selectedChain === 'sui'
                    ? 'bg-teal-100 border-teal-500 shadow-lg shadow-teal-500/10'
                    : 'bg-gray-50 border-gray-200 hover:border-teal-500/50'
                }`}
              >
                <div className="flex flex-col items-center">
